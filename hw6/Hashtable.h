 ...
 * Annabelle Huang
 * April 30th, 2023
 * Contains: Interface of Hashtable, using chaining for CPSC 223
...
private:
    ...
    // Added private parameters to create Hashtable table 
    // KeyValue vectors in vector
    // makes the initial number of elements in table zero
