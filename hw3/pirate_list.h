/*
    ...
    CPSC 223 HW 2
    March 10th, 2023
    Purpose: declare function headers that are defined in
    pirate_list.c and used in hookbook.c to alphabetically
    sort and return pirate names given by an input file 
*/ 
